	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6 p-5">
				<img src="images/Doctor 2.jpg" width="450px" height="450px">
			</div>
					...
					<div class="card-body">
						...
						<form class="row g-3" action="userAppointment" method="post">
							...
							<c:if test="${empty userObj }">
								<a href="user_login.jsp" class="col-md-7 offset-md-3 btn btn-danger">Submit</a>
							</c:if>

							<c:if test="${not empty userObj }">
								<button class="col-md-7 offset-md-3 btn btn-danger">Submit</button>
							</c:if>
						</form>
					</div>
				</div>
